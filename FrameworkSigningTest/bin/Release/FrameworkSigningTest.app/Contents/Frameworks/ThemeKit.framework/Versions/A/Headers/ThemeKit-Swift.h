...
#ifndef THEMEKIT_SWIFT_H
#define THEMEKIT_SWIFT_H
...
@property (nonatomic, strong) NSURL * _Nullable userThemesFolderNSUrl;
- (id <TKTheme> _Nullable)getThemeWithIdentifier:(NSString * _Nullable)identifier SWIFT_WARN_UNUSED_RESULT;
- (id _Nullable)getActiveThemeAssetWithKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
- (void)themeWindow:(NSWindow * _Nonnull)window;
@end
