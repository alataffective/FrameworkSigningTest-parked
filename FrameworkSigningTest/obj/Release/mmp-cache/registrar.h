...
@interface TKTheme : NSObject<TKTheme> {
}
	-(id) init;
@end
...
@interface TKThemeManager : NSObject {
	...
	-(NSObject *) getActiveThemeAssetWithKey:(NSString *)p0;
	-(id) getThemeWithIdentifier:(NSString *)p0;
	-(void) themeWindow:(NSWindow *)p0;
	-(id) theme;
	-(void) setTheme:(id)p0;
	-(NSURL *) userThemesFolderNSUrl;
	-(void) setUserThemesFolderNSUrl:(NSURL *)p0;
	-(id) init;
@end
